...
from apps.websayt.views.operator import OperatorIndexTemplateView, OperatorNewListView, OperatorOrderListView
from apps.websayt.views.products import ProductListView, ProductDetailView, OrderProductSuccessDetailView, \

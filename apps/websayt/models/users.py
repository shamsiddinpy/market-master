...
from apps.websayt.manager import CustomerUserManager
...
class User(AbstractUser):
    ...
    region = ForeignKey('websayt.Region', CASCADE, blank=True, null=True, verbose_name='Viloyat')  # delete
    district = ForeignKey('websayt.District', CASCADE, blank=True, null=True, verbose_name='Tuman ')  # delete
...
class PaymeRequest(Model):
    ...
    user = ForeignKey('websayt.User', CASCADE)
...
class Profile(Model):
    operator = OneToOneField('websayt.User', CASCADE, verbose_name='operator_ismi')
